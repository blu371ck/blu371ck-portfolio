...
const App = () => {
  ...
  return (
    <div className="relative bg-black font-sans text-white">
      ...
      <section ref={contactRef} className={`relative min-h-screen flex flex-col items-center justify-center py-20 transition-opacity duration-1000 ease-in-out z-10 ${isNavOpen ? 'md:ml-64' : 'md:ml-20'} ${isContactVisible ? 'opacity-100' : 'opacity-0'}`}>
        <Contact />
      </section>
    </div>
  );
